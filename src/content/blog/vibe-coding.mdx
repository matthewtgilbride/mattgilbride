...
I should admit that I use these tools heavily at work too, so I'm probably more adept than most at getting value out of them. But when I sat down with Claude Code — Anthropic's CLI tool — to tackle some long-overdue technical debt on a couple of side projects, I still wasn't expecting to be impressed. I just wanted to migrate off Prismic CMS, modernize some styling, fix some mobile layout bugs, and clean up years of accumulated cruft.
